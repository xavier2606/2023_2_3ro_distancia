<?php
    ...
    $comandoARealizar = "update  productos set nombres='$varNombre', precio='$varPrecio', idcategorias='$varCategorias', estado='$varVenta' where id='$varId'";
...
<div class="container-fluid bg-danger text-white  ">
    ...
    <div class="container py-2">
        <?php
            //Recuperando los datos del formulario pacienteInsertar.php
            echo '<h3 class="p-3 mb-2 bg-primary-subtle"> Producto actualizado satisfactoriamente. </h3>';
        ?>
